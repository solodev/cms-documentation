...
**Name** | **Description** 
:--- | ---
Add Website | Click the "Add website" card on the right to <a href="/workspace/websites/add-website/">add a new website</a>.
Enter Website | Click the website you want to open and <a href="/workspace/websites/update-website/">modify</a>.

## Fields

**Name** | **Description** 
:--- | ---
Search Name | You can filter websites based on their names. To find a specific website enter the search name.
