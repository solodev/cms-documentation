...
<p><img src="/static/images/folders/update-folder.jpg" alt="Update Folder Modal" style="width: 35%;"></p>
...
<p><img src="/static/images/folders/website-properties.jpg" alt="Website Properties" style="width: 30%;"></p>

**Name** | **Description**
:--- | ---
Menu Name | If you want a different title to appear in the menu navigation compared to the folder title.
...
Datable Category ID | The ID for a specific category.
Image | Upload an image to the folder or update a current one.
...
<p><img src="/static/images/folders/advanced.jpg" alt="Advanced Section" style="width: 35%;"></p>
