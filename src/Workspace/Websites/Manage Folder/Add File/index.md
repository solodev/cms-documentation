...
- **Template Code** &mdash; Solodev's text editor supports a wide range of code file types, including .js, .css, .php, .xml, and .json. To use JavaScript or CSS files across all pages, reference the file path in the Global Header Insert found in [Update Website](/workspace/websites/website-overview/update-website/).
