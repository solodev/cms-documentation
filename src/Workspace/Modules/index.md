...
- RESTful APIs - Utilize a built-in API to expose data table information to external publishing channels such as websites, mobile apps, intranets, and other API-enabled technologies.
...
- Custom – a custom calendar gives users the ability to tailor a calendar type to their needs – using some or all the functionality in the aforementioned calendar types. 
