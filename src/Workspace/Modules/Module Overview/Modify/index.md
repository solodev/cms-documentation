...
Display/Hide Columns | Use this option to display/hide columns. To do so, use arrows in the middle of fields.
...
**Name** | **Description** 
:--- | ---
Upload Form | Choose this option if you want to upload form from your PC.
