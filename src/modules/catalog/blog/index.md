...
<div class="header">
  ...
  <a href="https://solodev-blog.s3.us-east-1.amazonaws.com/releases/blog-latest.zip" rel="noopener noreferrer" target="_blank" class="btn-blue-lg"><span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="20" height="20" fill="#fff"><path d="M2.75 14A1.75 1.75 0 0 1 1 12.25v-2.5a.75.75 0 0 1 1.5 0v2.5c0 .138.112.25.25.25h10.5a.25.25 0 0 0 .25-.25v-2.5a.75.75 0 0 1 1.5 0v2.5A1.75 1.75 0 0 1 13.25 14Z"></path><path d="M7.25 7.689V2a.75.75 0 0 1 1.5 0v5.689l1.97-1.969a.749.749 0 1 1 1.06 1.06l-3.25 3.25a.749.749 0 0 1-1.06 0L4.22 6.78a.749.749 0 1 1 1.06-1.06l1.97 1.969Z"></path></svg></span>DOWNLOAD</a>
</div>
...
<img src="../../../Images/modules/blog/add-blog.jpg" alt="Add Blog" style="width: 40%; margin-bottom: 20px;">

!!!Note:
The blog module comes with pre-configured entries that you can customize by accessing the module entries.
!!!
...
<div class="container my-6">
  <div class="row text-center justify-content-center">
    <div class="col-md-8 col-xxl-7">
      <h1>Blog</h1>
      <p class="fs-5">With the Blog module, you can customize the experience to drive your SEO. Publish news, articles, and more using simple fields.</p>
    </div>
  </div>
  <div class="mt-5">
      ...
      <div class="row border-bottom py-4">
        <div class="col-lg-3">
          [is_set value="{{post_image}}"]	
            <img alt="{{event_title}}" src="[get_asset_file_url id='{{post_image}}']" class="w-100">
          [/is_set]
          [is_empty value="{{post_image}}"]
            <img alt="{{event_title}}" class="w-100" src="/_/images/blog-1.png" />
          [/is_empty]
        </div>
...
5. [Insert your blog repeater file](/websites/page-overview/#add-a-file-to-page) into the page you just created.

6. Click <span class="text-blue">Publish</span>.

7. Go to your website and refresh the page to see your blog in action.

<img src="../../../Images/modules/blog/blog-list.jpg" alt="Blog Repeater on Page">
...
4. Navigate to `www > blog` and [create a new page](/websites/add-page/) called `detail.stml`. Select a template (optional).

5. [Insert your blog detail file](/websites/page-overview/#add-a-file-to-page) into the page you just created.
...
<img src="../../../Images/modules/blog/blog-detail.jpg" alt="Blog Detail on Page">
