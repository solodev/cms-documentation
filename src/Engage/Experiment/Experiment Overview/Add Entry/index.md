...
Frequency | The percentage of traffic this variant should receive. Solodev picks a variant to show on each visit, weighted by every active variant's frequency. Frequencies are manually adjustable with a slider control.
