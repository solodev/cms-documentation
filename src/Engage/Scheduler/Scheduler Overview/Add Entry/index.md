...
**Name** | **Description**
:--- | ---
Select a file from the workspace | Click **Browse** to choose the HTML or TPL file this entry should show.
Start Date | Pick the date and time this entry should go live. Once it's the most recent start date that's already passed, this entry becomes the one that's shown on your website.
