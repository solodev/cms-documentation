...
**Step 1**. Follow [these steps](../../../../../websites/add-page/) to create a page. Shortcodes for creating a login page [can be found here](/shortcodes/shortcodes-for-login-forms).
