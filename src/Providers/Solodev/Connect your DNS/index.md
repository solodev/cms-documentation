...
After configuring the DNS, you can add websites to your CMS by going to <a href="https://cms.solodev.net/websites/add-website/" target="_blank">add website</a> and follow the provided steps to add your websites to the CMS platform.
