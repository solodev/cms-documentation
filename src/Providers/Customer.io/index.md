...
<p><img src="../../images/admin/settings/providers/customerio-card.png" alt="Customer.io provider card: Messaging Provider, Forms and Contacts support" style="width: 38%;"></p>
