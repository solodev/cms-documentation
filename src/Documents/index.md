...
To access additional actions, simply select the checkbox next to the item you wish to modify, and then choose from options like <a href="/documents/manage-file-folder/copy/">copying</a>, <a href="/documents/manage-file-folder/move/">moving</a>, or <a href="/documents/manage-file-folder/delete/">deleting</a> the selected item.
