...
In Solodev, you can add a <a href="/forms/">form</a> to a web page to collect information for almost any kind of application. There are three ways to create a form in Solodev:

## Add Form Options

From the main dashboard, there are three ways to add a form to Solodev:

*	**<a href="/forms/add-form/#form-studio">Form Studio</a>**
...
* **<a href="/forms/add-form/#upload-tpl-file">Upload TPL File</a>**
...
* **<a href="/forms/add-form/#add-html-code">Upload HTML</a>**
