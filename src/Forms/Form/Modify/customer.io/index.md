...
- Have a [Solodev form](/forms/form/).
...
<p><img src="/images/form/settings-main-nav.jpg" alt="Main navigation with Settings link highlighted" style="width: 10%;"></p>

2. On the left navigation, click on **Config**.

<p><img src="/images/form/config-nav.jpg" alt="Settings navigation with Config link highlighted" style="width: 10%;"></p>

3. Navigate to the Customer.io accordion.

<p><img src="/images/form/cio-config-accordion.jpg" alt="Customer.io Accordion" style="width: 40%;"></p>

4. Add the Site ID, Track API Key, and App API Key.

<p><img src="/images/form/cio-credentials.jpg" alt="Customer.io Credentials" style="width: 80%;"></p>
