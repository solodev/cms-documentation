...
Customize your form's name, type, and styles, including the displayed fields. You can also update [email options](/forms/form/modify/email/), [table schema](/forms/form/modify/#table-schema), [relationships](/forms/form/modify/#relationships), [API details](/forms/form/modify/#api-info), [customer.io setup](/forms/form/modify/customer.io) and other [advanced settings](/forms/form/modify/advanced/).

<p><img src="/images/form/modify-form.jpg" alt="Modify Form" style="width: 50%;"></p>
