...
<div class="header">
  <div class="inner">
    ...
    <div>
      <h1>Pro</h1>
      <p style="padding-left:0;">The theme for pros! Build business-grade sites using a complete, mobile-responsive theme package with multiple pages and ready-to-go modules.</p>
    </div>
  </div>
...
Pro Theme is a business-grade, multi-page responsive theme package, built on the [Bootstrap 5.3](https://getbootstrap.com/)  engine and fully customizable with ease -- the step up from Micro Theme for sites that need more than one page.
...
Pro Theme is a multi-page website template package built for businesses that have outgrown a single-page site.

* Multiple template pages, not just one
* Built on Bootstrap 5.3
* Blog, Calendar, and Shortcodes modules included
...
Support for Pro Theme is handled directly through Solodev's global help desk. For more information regarding support queries, go to <a href="https://www.solodev.com/" target="_blank" rel="noopener noreferrer">www.solodev.com</a>.
