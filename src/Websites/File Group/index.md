...
Once you have [created a File Group](/websites/folder/add-file-group/), you can begin adding and managing related files, such as images, documents, and other media.

<p><img src="/images/file-group/file-group-detail.jpg" alt="Add File Group" style="width: 80%;"></p>
...
[Add Entry](/websites/file-group/add-entry/) | Add a new file to the file group.
[Modify](/websites/file-group/modify/) | Modify the file group settings.
[Delete](/websites/file-group/delete/) | Delete a file group.
