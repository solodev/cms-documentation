You can update any page on your website under the www folder. You can directly edit your page using in-line editing tools with a visual preview, or by accessing component code elements for each section on your page. 

<p><img src="/images/websites/page/page.jpg" alt="Micro Main Page"></p>

**Name** | **Description**
:--- | ---
[Publish](/websites/pages/publish) | Push your code or content to live production. 
[Draft](/websites/pages/draft) | Create a draft version of your code or content.
[Stage](/websites/pages/stage) | Set up a staged version of your code or content for review as part of your workflow. 
[Copy](/websites/pages/copy) | Copy a page or asset for editing or additional use elsewhere in your website. 
[Move](/websites/pages/move) | Relocate a page or asset based on your taxonomy.
[Delete](/websites/pages/delete) | Delete a page or asset permanently from your website.
[History](/websites/pages/history) | Review previous versions of your content or code and restore a saved version.
[Add to File Group](/websites/pages/add-to-file-group) | Assign your page or asset to a specific file group.

!!!NOTE:
You will need to [add a website](/websites/add-website/) to your CMS before adding a page.
!!!
...
<p><img src="/images/websites/page/page-toolbar-actions.jpg" alt="Page Toolbar Actions" style="width: 30%;"></p>
...
<p><img src="/images/websites/page/page-left-nav.jpg" alt="Left Nav with stml file selected" style="width: 14%;"></p>
...
<p><img src="/images/websites/page/page-dynamic-div.jpg" alt="Dynamic div selected on a page" style="width: 80%;"></p>

3. Next, click on your file under the **web files** folder in the left menu. This will apply your content to the dynamic div.

<p><img src="/images/websites/page/page-left-nav-html.jpg" alt="Left Nav with html file selected" style="width: 14%;"></p>

4. Click **Publish** in the upper right corner.

<p><img src="/images/websites/page/publish-page.jpg" alt="Left Nav with html file selected" style="width: 80%;"></p>