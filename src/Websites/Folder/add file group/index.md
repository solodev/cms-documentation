...
<p><img src="/images/common/website-file-group-menu.jpg" alt="Add to File Group Menu" style="width: 20%;"></p>

2. Complete the form in the modal window.

<p><img src="/images/file-group/add-file-group.jpg" alt="Add File Group" style="width: 30%;"></p>
...
4. Add files to your file group by [following these steps](/websites/file-group/).