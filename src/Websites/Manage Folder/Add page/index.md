...
A page is the basic building block of a website. It acts as a container for your content while providing a general structure based on your [page template](/tutorials/websites/add-page-template/) and styling. From an open folder, click **+ Add** and select **Add Page**.
...
<p><img src="../../../../images/folders/add-page.png" alt="Add Page form" style="width: 40%;"></p>
...
Layouts | Choose a starting layout: **Blank Template** starts from an empty STML page, or pick a **Base Template** (Bootstrap-based) for a full-width shell with a reusable header, footer, and body layout drop zones.
