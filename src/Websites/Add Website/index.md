...
<p><img src="../../images/tutorials/add-website/add-website-form.jpg" alt="Add website form" style="width: 80%;" class="border"></p>
...
Web Framework | Choose the CSS/JS framework new pages are built with, or **Custom** to manage your own. Web frameworks speed up front-end development by letting you avoid writing CSS from scratch, ensuring responsive, consistent styling across a website or app. Includes an **Include framework CDN on page render** option — leave this off if you plan to download and bundle the framework assets yourself.
...
<p><img src="../../images/tutorials/add-website/add-website-theme-picker.png" alt="Theme Picker options: Blank, Micro, Pro, Enterprise, and Upload Theme Zip" class="border"></p>
...
The three named starter themes (Micro, Pro, Enterprise) are Solodev's own ready-made packages, downloaded automatically when selected.
...
<p><img src="../../images/websites/website-overview-new-site.png" alt="The newly created website's Website Overview dashboard" class="border"></p>
