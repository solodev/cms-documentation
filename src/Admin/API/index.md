...
<a href="/admin/api/api-keys/">API Keys</a> | An API key is similar to a password and allows you to authenticate to Solodev's APIs to perform actions as you. Here you can manage API keys. You need to use the link from the tree on the left to go there.
