...
The System API manages CMS platform objects: **websites, asset folders/files,
calendars, datatables, categories, forms, users/groups, providers, and other system
records**. Use it to discover or administer CMS objects. 

!!!Note:
Use the [Modules API](/admin/api/module-api/) to work with entries within a specific calendar or datatable.
!!!

<p><img src="../../../images/api/system-api.png" alt="System API Swagger" class="border"></p>
...
<p><img src="../../../images/api/authorize.png" alt="System API Swagger Authorize" class="border"></p>
...
<p><img src="../../../images/api/authentication-get.png" alt="System API Swagger forgotpassword" class="border"></p>
...
!!! Note:
The **id** after `/file/` is the parent folder id.
!!!
