...
<p><img src="/images/settings/config/config.jpg" alt="Config view" style="width: 90%;"></p>
...
<p><img src="/images/settings/config/organization-settings.jpg" alt="Organization Settings" style="width: 35%;"></p>
...
<img src="/images/email.jpg" alt="email" style="width: 80%; display: block"></a>
...
<p><img src="/images/settings/config/ssl-settings.jpg" alt="SSL Settings" style="width: 70%;"></p>
...
<p><img src="/images/settings/config/cache-settings.jpg" alt="Cache Settings" style="width: 90%;"></p>
...
<p><img src="/images/settings/config/click-tracking.jpg" alt="Click Tracking Settings" style="width: 90%;"></p>
...
<p><img src="/images/settings/config/rules-settings.jpg" alt="Rules Settings" style="width: 90%;"></p>
...
<p><img src="/images/settings/config/aws-settings.jpg" alt="AWS Settings" style="width: 90%;"></p>
...
<p><img src="/images/settings/config/google-settings.jpg" alt="Google Settings" style="width: 90%;"></p>
...
<p><img src="/images/settings/config/spam-keyword-list.jpg" alt="Spam Keyword List" style="width: 60%;"></p>
...
<p><img src="/images/settings/config/ip-quality-score.jpg" alt="IP Quality Score Settings" style="width: 60%;"></p>

## Salesforce

Solodev CMS allows you to integrate with Salesforce, the CRM platform.

<p><img src="/images/settings/config/salesforce-settings.jpg" alt="Salesforce Settings" style="width: 80%;"></p>
...
<p><img src="/images/settings/config/wowza-settings.jpg" alt="Wowza Settings" style="width: 80%;"></p>
...
<p><img src="/images/settings/config/payment-settings.jpg" alt="Payment Settings" style="width: 80%;"></p>
...
<p><img src="/images/settings/config/tasks-settings.jpg" alt="Tasks Settings" style="width: 80%;"></p>
...
<p><img src="/images/settings/config/customerio-settings.jpg" alt="Customer.io Settings" style="width: 80%;"></p>
...
<p><img src="/images/settings/config/sso-settings.jpg" alt="SSO Settings" style="width: 80%;"></p>
