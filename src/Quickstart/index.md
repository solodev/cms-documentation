...
<div style="width: 23%; margin-right: 1rem; display: flex; align-items: center; justify-content: center; flex-direction: column; float: left; padding: 1rem;" class="text-center border">
  ...
  <p style="height: 224px;">The perfect launch pad for small development projects, CMS Micro gives you optimal control in a streamlined package.</p>
...
<div style="width: 23%; margin-right: 1rem; display: flex; align-items: center; justify-content: center; flex-direction: column; float: left; padding: 1rem;" class="text-center border">
  <img src="../images/quickstart/cms-pro-logo.jpg" alt="CMS Pro Logo" style="width: 80px;">
  <h2 style="margin-top: 2rem; font-size: 1.4rem;"><a href="/quickstart/solodev-pro">CMS Pro</a></h2>
...
<div style="width: 23%; display: flex; align-items: center; justify-content: center; flex-direction: column; float: left; padding: 1rem;" class="text-center border">
  ...
  <h2 style="margin-top: 2rem; font-size: 1.4rem;"><a href="/quickstart/solodev-cms-for-kubernetes">CMS for EKS</a></h2>
  <p style="height: 224px;">Designed for enterprise-level demands, CMS for EKS gives you best-of-breed features and advanced capabilities on a secure architecture managed by Amazon EKS.</p>
