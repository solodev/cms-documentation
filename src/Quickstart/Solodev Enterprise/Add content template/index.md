...
If you'd like to, you can add a description of the page. Click Submit.
...
Find and click on the template file from the left tree and it will be placed on the page. Click Publish.
...
If you followed the instructions your sectional template should appear as at the beginning of the "Create a sectional template" section.
