...
<p style="margin: .75rem 0 1.5rem;">Already subscribed? <a class="btn-blue-lg" href="https://console.aws.amazon.com/cloudformation/home?region=us-east-1#/stacks/create?stackName=solodev-cms-micro&templateURL=https://s3.amazonaws.com/solodev-cms/cloudformation/solodev-micro-linux.yaml" target="_blank" rel="noopener noreferrer" style="padding: .35rem 1.75rem; font-size: .85rem;">LAUNCH <span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16" fill="#fff"><path d="M9.5 2c-1.955 0-3.9.685-5.256 1.918a.75.75 0 0 0-.244.55v2.084L2.276 8.276A2.75 2.75 0 0 0 1.5 10.19V13.5a.75.75 0 0 0 .75.75h3.31c.73 0 1.43-.29 1.945-.805l1.724-1.724h2.084a.75.75 0 0 0 .55-.244C13.315 10.4 14 8.455 14 6.5 14 3.5 12.5 2 9.5 2Zm-2.9 9.69-1.724 1.725a.75.75 0 0 1-.53.22H3v-1.446a1.25 1.25 0 0 1 .354-.874L4.31 10.354ZM10 8a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3Z"></path></svg></span></a></p>
...
!!!NOTE:
If you already have a subscription to CMS Micro AWS, [click here](#aws-setup-with-subscription).
!!!
