...
On the groups page, there is a full list of existing groups with the details as names and members who belong to them.
...
**Name** | **Description** 
:--- | ---
Add Group | Click the blue "Add Group" button on the right to <a href="/organization/groups-overview/add-group/">add a new group</a>.
Enter Group | Click the group you want to open and <a href="/organization/groups-overview/modify/">modify</a>.

## Fields

**Name** | **Description** 
:--- | ---
Search Name | You can filter users based on their names. To find a specific group enter the search name.
