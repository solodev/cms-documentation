...
**Step 6**: Once your package-lock.json file is created, follow steps 3 and 4. In the editor, add the code sample below, then click **Publish**.
...
```js
{
  ...
  "dependencies": {
    ...
    "slick-carousel": {
      "version": "github:kenwheeler/slick#fcbb70db301451d5542b12277be9222b61007306",
      "from": "github:kenwheeler/slick",
      "dev": true
    },
    "sockjs": {
      "version": "0.3.24",
