...
<!-- - If you want to install an optional theme to your website, learn how to <a href="/tutorials/websites/how-to-make-a-theme//">add a theme</a>. -->
...
!!!Note: 
You can upload a theme on the add site step. To learn more about it click here (take to Add Site with a Theme section on this same page).
!!!

**Step 2**: Upload a theme package with your website. Must be in .zip format.

**Step 3**: In the form fields, enter your website address and select your timezone.
