...
**Step 1**: Click on the **about** folder and on the right menu, click <a href="/websites/add-page/">Add Page</a>. Create a new page called **index.stml**. Once complete, click **Submit**.
...
**Step 5**: Finally click on the **www** folder and on the right menu, click <a href="../../../websites/add-page/">Add Page</a>. Create a new page called **privacy.stml**. Once complete, click **Submit**:
