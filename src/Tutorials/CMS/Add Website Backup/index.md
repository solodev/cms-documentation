...
**Step 2**: Using the right-hand menu, click <a href="/websites/folders/add-folder/">Add Folder</a>. 
...
**Step 4**: Click back on the templates folder. Using the same right-hand menu, click <a href="/websites/folders/add-file/">Add File</a>. 
...
**Step 2**: Using the right-hand menu, click  <a href="/websites/folders/add-folder/">Add Folder</a>. Under **templates**, add four folders with the following names:
...
**Step 3**: Under **templates**, click on the **base** folder. In the right menu, click <a href="/websites/folders/add-file/">Add File</a>. Create a new file named **div-insert.tpl** and select **Code** from the **File Type** dropdown. When complete, click **Submit**.
...
**Step 4**: In each of the new folders, you will need to add a new .tpl file. Follow the previous steps to click on each folder and <a href="/websites/folders/add-file/">Add File</a>. Create a new file under each folder as follows, and select **Code** for the **File Type**. Once complete, click **Submit**:
...
the <a href="/websites/folders/upload/">Upload</a> article under Manage Folder in Websites.  
!!!
...
**Step 2**: Using the right-hand menu, click <a href="/websites/folders/add-folder/">Add Folder</a>. Under **content**, add folder called **about**. Click **Submit**, when complete.

<img src="/images/about-folder-web-files.png" alt="about folder web files" style=" display: block"></a>

**Step 3**: Now you will need to add a new .tpl file into the folder you have just created. Under **content**, click on the **about** folder and on the right menu, click <a href="/websites/folders/add-file/">Add File</a>. Create a new file called **about.tpl** and select **Code** for the **File Type**. Once complete, click **Submit**.

<img src="/images/about-file-web-files.png" alt="about file web files" style=" display: block"></a>

**Step 4**: You will also need to add a new .tpl file into the folder listed below. Under **templates**, click on the correct folder and on the right menu, click <a href="/websites/folders/add-file/">Add File</a>. Create a new file under the folder and select **Code** for the **File Type**. Once complete, click **Submit**:

  *	content: **full-width-template.tpl**

<img src="/images/full-width-code.png" alt="full-width-code" style=" display: block"></a>

**Step 5**: Click on the **www** folder and on the right menu, click <a href="/websites/folders/add-folder/">Add Folder</a>, and add folder called **about**. Click **Submit**, when complete.

<img src="/images/about-folder-www.png" alt="about-folder-www" style=" display: block"></a>

### Adding templates to your dynamic divs

**Step 1**: Click on the **about** folder and on the right menu, click [Add Page](/websites/folder/add-page). Create a new page called **index.stml**. Once complete, click **Submit**.
...
**Step 2**: Using the right-hand menu, click  <a href="/websites/folders/add-folder/">Add Folder</a>. Under **content**, add folder called **privacy**. Click **Submit**, when complete.

<img src="/images/content-template-add-folder.png" alt="base template" style="width: 20%; display: block"></a>

**Step 3**: Now you will need to add a new .html file into the folder you have just created. Under **content**, click on the **privacy** folder and on the right menu, click <a href="/websites/folders/add-file/">Add File</a>. Create a new file called **privacy.html**, and select **HTML** for the **File Type**. Once complete, click **Submit**.

<img src="/images/content-template-add-file1.png" alt="base template" style="width: 20%; display: block"></a>

**Step 4**: You will also need to add a new .tpl files into a folders listed below. Under **templates**, click on the correct folder and on the right menu, click <a href="/websites/folders/add-file/">Add File</a>. Create a new file under each folder, and select **Code** for the **File Type**. Once complete, click **Submit**:
...
**Step 5**: Finally click on the **www** folder and on the right menu, click [Add Page](/websites/folder/add-page). Create a new page called **privacy.stml**. Once complete, click **Submit**:
