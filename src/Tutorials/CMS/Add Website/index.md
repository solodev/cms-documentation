...
- Once you have a URL, you need to point your domain’s DNS records to the server where your Solodev CMS is hosted on AWS. Visit your registrar’s website for instructions. To locate your server’s IP address in AWS, review the Quickstart for [Solodev CMS Kubernetes for EKS](../../../quickstart/solodev-cms-for-kubernetes/), [Solodev CMS Enterprise Edition](../../../quickstart/solodev-enterprise/), or [Solodev CMS Professional Edition](../../../quickstart/solodev-pro/).
