...
- Once downloaded, you will need to <a href="/websites/add-website/">add a website</a> to your Solodev CMS and follow the prompts to upload an optional theme. 
...
To create a theme, you need to first create a website. Solodev consists of 2 main folders, <a href="/websites/website-overview/#web-files">web files</a> and <a href="/websites/website-overview/manage-folder">www folder</a>. Web files is where all your files reside and www where your pages live.
...
- [Add Page](/websites/folder/add-page)
