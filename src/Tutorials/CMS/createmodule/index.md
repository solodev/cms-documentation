...
!!!**Note**:
You can also add users to your form module. To learn more, read the <a href="/workspace/websites/folder/add-folder/">Add Form</a> article. 
!!!
...
**Step 2:**  In that folder, <a href="/workspace/websites/folder/add-file/">add a file</a> for the module repeater called **index.tpl**. 
