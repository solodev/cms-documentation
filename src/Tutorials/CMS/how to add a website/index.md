...
- Once you have a FQDN, you need to point your domain’s DNS records to the server where your Solodev CMS is hosted on AWS. Visit your registrar’s website for instructions. To locate your server’s IP address in AWS, review the Quickstart for [CMS for EKS](/quickstart/solodev-cms-for-kubernetes/), [CMS Enterprise](/quickstart/solodev-enterprise/), [CMS Professional](/quickstart/solodev-pro/), or [CMS Micro](/quickstart/solodev-micro/).
