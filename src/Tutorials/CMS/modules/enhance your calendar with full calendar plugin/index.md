...
- A [Website](/websites/add-website/) set up in your workspace
...
1. [Create a code shortcodes file](/websites/folder/add-file/) if you don't already have one. Call it **shortcodes.php** and place it under `www > _ > php` (optional, but recommended).
...
1. Navigate to `web files > content` and [create a new code file](/websites/folder/add-file/).
...
3. [Create a page](/websites/folder/add-page) in your calendar folder and name it `index.stml`.

4. [Insert your calendar file](/websites/page/#add-a-file-to-page) into the page you just created.
...
1. Go to the folder in `web files` where you saved your calendar file and [create a new code file](/websites/folder/add-file/) in the same directory.
...
3. [Create a page](/websites/folder/add-page) in your calendar folder and name it exactly `list.stml`.

4. [Insert your calendar list file](/websites/page/#add-a-file-to-page) into the page you just created.
...
1. Navigate to the folder in `web files` where you saved your calendar file and [create a new code file](/websites/folder/add-file/) in the same directory. This file will serve as the template to display individual calendar entry details.
...
3. [Create a page](/websites/folder/add-page) in your calendar folder to display individual calendar entry details.

4. [Insert your calendar detail file](/websites/page/#add-a-file-to-page) into the page you want to display the entries on.
...
6. Click [Add Entry](/modules/module/add-entry/) to begin adding content to your module.

7. Go to your website and refresh the page to see your calendar module in action.

<img src="/images/modules/calendar/calendar-page.jpg" alt="Calendar" style="width: 90%; margin-bottom: 20px;">
