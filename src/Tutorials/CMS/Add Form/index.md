...
-	After selecting a website, you will need to [add a page](/websites/folder/add-page) for your form.
...
!!!Note: 
If you need to add more options to your form submissions, like having each department on your company receive the form submission based on what the user selects on the forms, please visit <a href="/forms/form/workflow/">workflows</a>.
!!!
