...
<img src="../../../images/create-a-package.png" alt="document-overview" style="width: 100%; display: block"></a>

* After creating the website, open the website and click **Settings**.

<img src="../../../images/create-settings.png" alt="document-overview" style="width: 100%; display: block"></a>

* In the modal window click the **Advanced** tab to access the advanced options.

<img src="../../../images/create-advanced.png" alt="document-overview" style="width: 50%; display: block"></a>

* Click **Export Package**. 

<img src="../../../images/create-export-package.png" alt="document-overview" style="width: 50%; display: block"></a>
...
<img src="../../../images/create-continue-export.png" alt="document-overview" style="width: 50%; display: block"></a>

* The user is directed to modal window to download the package. 
* Click **Download Package**. 

<img src="../../../images/create-download.png" alt="document-overview" style="width: 50%; display: block"></a>

* The zip file will be found in the folder that is assigned to Downloads in the web browser.   

<img src="../../../images/crerating_packages_7.jpg" alt="document-overview" style="width: 100%; display: block"></a>