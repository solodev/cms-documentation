...
**Step 1**. Start by navigating to the following URL: <a href="/quickstart/solodev-pro/#step-6-view-cloudformation-stack-outputs" target="_blank">click here</a>. On this page, you will find the CloudFormation stack outputs.
...
After configuring the DNS, you can add websites to your CMS by going to <a href="/workspace/websites/add-website/" target="_blank">add website</a> and follow the provided steps to add your websites to the CMS platform.
