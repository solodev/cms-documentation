...
1.	To get started go to **web files > templates** and <a href="/websites/folders/add-file/">add a file</a>.
...
1.	Go to **web files > templates** and <a href="/websites/folders/add-file/">add a file</a>.
2.	Name the file, choose **Code** from the File Type dropdown, and click **Publish**.
