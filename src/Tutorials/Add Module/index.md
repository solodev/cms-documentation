...
**Step 1**.	<a href="/workspace/websites/manage-folder/add-file/">Add a file</a> for the module repeater.
...
**Step 1**.	<a href="/workspace/websites/manage-folder/add-file/">Add a file</a> for the module detail.
