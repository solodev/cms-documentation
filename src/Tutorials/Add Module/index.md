...
A <a href="/modules/">module</a> can be added to any website in Solodev. In this article, you will learn how to install a module, how to add both a repeater and detail template, and how to map a detail page to your module.
...
-	You will need to <a href="/websites/manage-folder/add-page/">add a page</a>.
...
**Step 1**.	<a href="/websites/manage-folder/add-file/">Add a file</a> for the module repeater.
...
**Step 1**.	<a href="/websites/manage-folder/add-file/">Add a file</a> for the module detail.
